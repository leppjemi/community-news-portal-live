...
class EditorNewsSubmissionForm extends Component
{
    ...
    public $redirectRoute = 'editor.submissions'; // Default redirect route
    ...
    public function mount($postId = null, $redirectRoute = null)
    {
        // Set custom redirect route if provided
        if ($redirectRoute) {
    ...
    public function save()
    {
        try {
            ...
            if ($this->postId) {
                ...
                // Editors always publish directly
    ...
    public function render()
    {
        ...
        return view('livewire.editor-news-submission-form', compact('categories'));
    }
}
