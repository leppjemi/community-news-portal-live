...
class RejectedArticlesList extends Component
{
    ...
    public function deletePost()
    {
        ...
        // Editors can delete rejected posts from regular users
        $post->delete();
    ...
    {
        // Show all rejected posts from other users (not the current editor)
        ...
        $posts = $query->latest('updated_at')->paginate(12);

        // Get categories for filter dropdown
        $categories = Category::orderBy('name')->get();

        return view('livewire.rejected-articles-list', compact('posts', 'categories'));
    }
}
