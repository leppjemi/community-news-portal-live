...
@section('content')
    <div class="container mx-auto px-4 py-8">
        <!-- Hero Section -->
        <div class="relative overflow-hidden rounded-3xl bg-warning text-warning-content shadow-2xl mb-12">
                ...
                <div class="flex flex-col md:flex-row items-center justify-between gap-6">
                    <div>
                        <h1 class="text-4xl md:text-5xl font-black mb-4 tracking-tight">
                            Welcome back,<br/>{{ $user->name }}! ✍️
                        </h1>
                        <p class="text-lg opacity-90 max-w-xl font-medium">
                            Ready to publish your next story? As an editor, your posts go live instantly.
                        </p>
                    </div>
                    <div class="hidden md:block">
                        <a href="{{ route('editor.submit-news') }}" class="btn btn-lg btn-surface text-warning border-0 shadow-lg hover:scale-105 transition-transform">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div class="card bg-base-100 shadow-lg hover:shadow-xl transition-all duration-300 border-b-4 border-info">
                        <div class="card-body p-4 items-center text-center">
                            ...
                            <div class="text-3xl font-bold">{{ $pendingReviews }}</div>
                            <div class="text-xs uppercase tracking-wider font-semibold opacity-60">To Review</div>
                        </div>
                    </div>

                    <!-- Views -->
                    <div class="card bg-base-100 shadow-lg hover:shadow-xl transition-all duration-300 border-b-4 border-secondary">
                        <div class="card-body p-4 items-center text-center">
                            <div class="w-12 h-12 rounded-full bg-secondary/10 flex items-center justify-center mb-2 text-secondary">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div>
                    <div class="flex items-center justify-between mb-6">
                        <h2 class="text-2xl font-bold flex items-center gap-2">
                            <span class="w-2 h-8 bg-warning rounded-full"></span>
                            Recent Articles
                        </h2>
                        <a href="{{ route('editor.submissions') }}" class="btn btn-ghost btn-sm group">
                            View All
                            ...
                            @foreach($recentSubmissions as $post)
                                <div class="card bg-base-100 shadow-md hover:shadow-2xl transition-all duration-300 group">
                                    ...
                                    <div class="card-body p-6">
                                        <h3 class="card-title text-lg font-bold line-clamp-2 group-hover:text-warning transition-colors">
                                            {{ $post->title }}
                                        </h3>
                                        <div class="flex items-center justify-between mt-4 pt-4 border-t border-base-200">
                                            ...
                                            <a href="{{ route('news.show', $post->slug) }}" class="btn btn-sm btn-ghost text-warning">View</a>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                    ...
                    @else
                        <div class="card bg-base-100 shadow-xl border-2 border-dashed border-base-300">
                            <div class="card-body text-center py-12">
                                ...
                                <p class="text-base-content/60 mb-6 max-w-md mx-auto">You haven't published any articles yet. Start sharing your stories with the community!</p>
                                <a href="{{ route('editor.submit-news') }}" class="btn btn-warning">
                                    Start Publishing
                                </a>
                            </div>
                        </div>
            ...
            <!-- Right Column: Quick Actions & Info (4 cols) -->
            <div class="lg:col-span-4 space-y-8">
                ...
                <div class="card bg-base-100 shadow-xl overflow-hidden">
                    ...
                    <div class="card-body p-0">
                        <div class="grid grid-cols-1 divide-y divide-base-200">
                            <a href="{{ route('editor.submit-news') }}" class="flex items-center gap-4 p-4 hover:bg-base-200 transition-colors group">
                                <div class="w-10 h-10 rounded-lg bg-warning/10 flex items-center justify-center text-warning group-hover:bg-warning group-hover:text-white transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                                    </svg>
                                </div>
                                <div class="flex-1">
                                    <div class="font-bold">Publish Article</div>
                                    <div class="text-xs text-base-content/60">Goes live instantly</div>
                                </div>
                            ...
                            <a href="{{ route('editor.submissions') }}" class="flex items-center gap-4 p-4 hover:bg-base-200 transition-colors group">
                                ...
                                <div class="flex-1">
                                    <div class="font-bold">My Submissions</div>
                                    <div class="text-xs text-base-content/60">Manage your posts</div>
                                </div>
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-base-content/30" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                                </svg>
                            ...
                            <a href="{{ route('editor.review-queue') }}" class="flex items-center gap-4 p-4 hover:bg-base-200 transition-colors group">
                                <div class="w-10 h-10 rounded-lg bg-info/10 flex items-center justify-center text-info group-hover:bg-info group-hover:text-white transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                                    </svg>
                                </div>
                                <div class="flex-1">
                                    <div class="font-bold">Review Queue</div>
                                    <div class="text-xs text-base-content/60">{{ $pendingReviews }} pending</div>
                                </div>
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-base-content/30" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                                </svg>
                            ...
                            <a href="{{ route('editor.settings') }}" class="flex items-center gap-4 p-4 hover:bg-base-200 transition-colors group">
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="text-xs text-base-content/60">Update your profile</div>
                                </div>
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-base-content/30" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                                </svg>
                ...
                <div class="card bg-base-100 shadow-xl border border-warning/20">
                    <div class="card-body">
                        <h3 class="font-bold text-lg mb-2">Editor Privileges ⭐</h3>
                        <ul class="space-y-3 text-sm text-base-content/80">
                            <li class="flex gap-2">
                                <span class="text-success">✓</span>
                                <span>Instant publishing - no approval needed</span>
                            </li>
                            <li class="flex gap-2">
                                <span class="text-success">✓</span>
                                <span>Review and approve user submissions</span>
                            </li>
                            <li class="flex gap-2">
                                <span class="text-success">✓</span>
                                <span>Edit your published articles anytime</span>
                            </li>
                        </ul>
                    </div>
                </div>
