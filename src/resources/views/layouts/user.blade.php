...
<body class="min-h-screen bg-base-200">
    <div class="drawer lg:drawer-open">
        ...
        <div class="drawer-content">
            ...
            <div class="navbar bg-base-100 shadow-md sticky top-0 z-30">
                ...
                <div class="flex-none lg:hidden">
                    <label for="user-drawer" class="btn btn-ghost btn-square">
                ...
                <!-- Logo/Title -->
                <div class="flex-1">
                    <a href="{{ route('user.dashboard') }}" class="btn btn-ghost normal-case text-xl">
        ...
        <div class="drawer-side z-40">
            ...
            <aside id="user-sidebar" class="bg-base-100 min-h-full shadow-xl transition-all duration-300"
                style="width: 280px;">
                <!-- Sidebar Header -->
                    ...
                    <div class="sidebar-content">
                        <div class="sidebar-text">
                            ...
                            <p class="text-xs text-base-content/70">
                                <span class="badge badge-info badge-sm">{{ ucfirst(Auth::user()->role) }}</span>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <ul class="menu p-4 space-y-2">
                    ...
                    <li>
                        <a href="{{ route('user.dashboard') }}"
                            class="{{ request()->routeIs('user.dashboard') ? 'active' : '' }}" title="Dashboard">
                    ...
                    <li>
                        <a href="{{ route('user.submit-news') }}"
                            class="{{ request()->routeIs('user.submit-news') ? 'active' : '' }}" title="Submit News">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M12 4v16m8-8H4" />
                    ...
                    <li>
                        <a href="{{ route('user.submissions') }}"
                            class="{{ request()->routeIs('user.submissions') ? 'active' : '' }}" title="My Submissions">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <li>
                        <a href="{{ route('user.settings') }}"
                            class="{{ request()->routeIs('user.settings') ? 'active' : '' }}" title="Settings">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
